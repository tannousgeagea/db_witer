# Generated by Django 4.2 on 2024-09-18 12:51
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('database', '0003_alter_wasteimpurity_img_id_and_more'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(help_text='The display name of the filter.', max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('item_value', models.CharField(help_text="The display value of the filter item (e.g., 'Störstoff').", max_length=255)),
                ('is_active', models.BooleanField(default=True, help_text='Indicates if the filter item is currently active.')),
                ('filter', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='items', to='database.filter')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('metadata', models.ForeignKey(help_text='The metadata this column belongs to.', on_delete=django.db.models.deletion.CASCADE, related_name='columns', to='database.metadata')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('metadata_column', models.ForeignKey(help_text='The metadata column being localized.', on_delete=django.db.models.deletion.CASCADE, related_name='localizations', to='database.metadatacolumn')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('filter', models.ForeignKey(help_text='The filter being localized.', on_delete=django.db.models.deletion.CASCADE, related_name='localizations', to='database.filter')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('filter_item', models.ForeignKey(help_text='The filter item being localized.', on_delete=django.db.models.deletion.CASCADE, related_name='localizations', to='database.filteritem')),
            ],
            options={
